                    ...
                    float *diag_approx_e)
{
    ...
    data->call(m_tensor, free_acc_tensor, vel_tensor, J_tensor,
        J_e_tensor, mu_tensor, pen_tensor, eq_res_tensor, diag_approx_c_tensor,
        diag_approx_e_tensor, h, ret_tensor);
